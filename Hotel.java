...
public class Hotel {
            ...
            case 1:
                for(j=0;j<hotel_ob.luxury_doublerrom.length;j++)
                {
                    if(hotel_ob.luxury_doublerrom[j]==null)
                    {
                        ...
                        if(j<hotel_ob.luxury_doublerrom.length-1){
                            System.out.print(",");
                        }
                    }
                }
            ...
            case 2:
                 for(j=0;j<hotel_ob.deluxe_doublerrom.length;j++)
                {
                    if(hotel_ob.deluxe_doublerrom[j]==null)
                    {
                        ...
                        if(j<hotel_ob.deluxe_doublerrom.length-1){
                            System.out.print(",");
                        }
                    }
                }
            ...
            case 3:
                  for(j=0;j<hotel_ob.luxury_singleerrom.length;j++)
                {
                    if(hotel_ob.luxury_singleerrom[j]==null)
                    {
                        ...
                        if(j<hotel_ob.luxury_singleerrom.length-1){
                            System.out.print(",");
                        }
                    }
                }
            ...
            case 4:
                  for(j=0;j<hotel_ob.deluxe_singleerrom.length;j++)
                {
                    if(hotel_ob.deluxe_singleerrom[j]==null)
                    {
                        ...
                        if(j<hotel_ob.deluxe_singleerrom.length-1){
                            System.out.print(",");
                        }
                    }
                }
    ...
    static void deallocate(int rn,int rtype)
    {
        ...
        switch (rtype) {
            case 1:               
                if(hotel_ob.luxury_doublerrom[rn]!=null)
                    System.out.println("Room used by \033[1m"+hotel_ob.luxury_doublerrom[rn].name);                
                else 
                {    
            ...
            case 2:
                if(hotel_ob.deluxe_doublerrom[rn]!=null)
                    System.out.println("Room used by \033[1m"+hotel_ob.deluxe_doublerrom[rn].name);                
                else 
                {    
                    System.out.println("Empty Already");
                        return;
            ...
            case 3:
                if(hotel_ob.luxury_singleerrom[rn]!=null)
                    System.out.println("Room used by \033[1m"+hotel_ob.luxury_singleerrom[rn].name);                
                else 
                 {    
                    System.out.println("Empty Already");
                        return;
            ...
            case 4:
                if(hotel_ob.deluxe_singleerrom[rn]!=null)
                    System.out.println("Room used by \033[1m"+hotel_ob.deluxe_singleerrom[rn].name);                
                else 
                 {    
                    System.out.println("Empty Already");
                        return;
